...
def pricing_metrics_to_document(metrics) -> Document:
    ...
    lines = [
        ...
        f"Cost per input token: ${metrics.cost_per_input_token:.8f} USD (per 1k tokens: ${metrics.cost_per_input_token:.6f})",
        f"Cost per output token: ${metrics.cost_per_output_token:.8f} USD (per 1k tokens: ${metrics.cost_per_output_token:.6f})",
