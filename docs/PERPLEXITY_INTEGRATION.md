...
Restart Perplexity. All 29 pricing tools are immediately available.
...
Perplexity should list all 29 tools. You can also verify directly via curl:

```bash
# Check server is up
curl https://llm-pricing-api.fly.dev/health

# List all 29 tools via MCP protocol
