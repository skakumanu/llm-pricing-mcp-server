...
28 MCP tools across two transports:
...
| `recommend_model` | `description` | `task_type`, `max_cost_per_1m_tokens`, `min_quality_score`, `min_context_window`, `preferred_provider`, `monthly_budget_usd` |
