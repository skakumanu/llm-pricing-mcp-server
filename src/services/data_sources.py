...
PRICING_SOURCES = {
    ...
    "Salesforce": PricingDataSource(
        provider="Salesforce",
        source_type=DataSourceType.HYBRID,
        api_endpoint="https://api.salesforce.com/einstein/platform/v1/models",
        pricing_url="https://www.salesforce.com/products/einstein/overview/",
        public_health_check="https://status.salesforce.com/",
        requires_auth=True,
        cache_ttl_seconds=7200,
    ),
    "PromptQL": PricingDataSource(
        provider="PromptQL",
        source_type=DataSourceType.HYBRID,
        api_endpoint="https://api.promptql.io/v1/models",
        pricing_url="https://promptql.io/pricing",
        public_health_check="https://promptql.io/",
        requires_auth=True,
        cache_ttl_seconds=7200,
    ),
    "Snowflake": PricingDataSource(
        provider="Snowflake",
        source_type=DataSourceType.HYBRID,
        api_endpoint="https://api.snowflake.com/v1/cortex/inference/complete",
        pricing_url="https://www.snowflake.com/en/data-cloud/cortex/",
        public_health_check="https://status.snowflake.com/",
        requires_auth=True,
        cache_ttl_seconds=7200,
    ),
    "Oracle OCI": PricingDataSource(
        provider="Oracle OCI",
        source_type=DataSourceType.HYBRID,
        api_endpoint="https://inference.generativeai.us-chicago-1.oci.oraclecloud.com/20231130/models",
        pricing_url="https://www.oracle.com/cloud/price-list/#generative-ai",
        public_health_check="https://ocistatus.oraclecloud.com/",
        requires_auth=True,
        cache_ttl_seconds=7200,
    ),
}
...
PERFORMANCE_SOURCES = {
    ...
    "Salesforce": PerformanceDataSource(
        provider="Salesforce",
        source_type=DataSourceType.HYBRID,
        api_endpoint="https://api.salesforce.com/einstein/platform/v1/models",
        health_check_endpoint="https://api.salesforce.com/einstein/platform/v1/models",
        public_status_page="https://status.salesforce.com/",
        cache_ttl_seconds=300,
    ),
    "PromptQL": PerformanceDataSource(
        provider="PromptQL",
        source_type=DataSourceType.HYBRID,
        api_endpoint="https://api.promptql.io/v1/models",
        health_check_endpoint="https://api.promptql.io/v1/models",
        public_status_page="https://promptql.io/",
        cache_ttl_seconds=300,
    ),
    "Snowflake": PerformanceDataSource(
        provider="Snowflake",
        source_type=DataSourceType.HYBRID,
        api_endpoint="https://api.snowflake.com/v1/cortex/inference/complete",
        health_check_endpoint="https://api.snowflake.com/v1/cortex/inference/complete",
        public_status_page="https://status.snowflake.com/",
        cache_ttl_seconds=300,
    ),
    "Oracle OCI": PerformanceDataSource(
        provider="Oracle OCI",
        source_type=DataSourceType.HYBRID,
        api_endpoint="https://inference.generativeai.us-chicago-1.oci.oraclecloud.com/20231130/models",
        health_check_endpoint="https://ocistatus.oraclecloud.com/",
        public_status_page="https://ocistatus.oraclecloud.com/",
        cache_ttl_seconds=300,
    ),
}
