...
_openapi_tags = [
    {
        "name": "Pricing",
        "description": "Live LLM model pricing data across 26 providers (150+ models). Supports filtering by provider and capability.",
    },
    {
...
if _static_dir.exists():
    ...
    _whats_new_dir = _static_dir / "whats-new"
    if _whats_new_dir.exists():
        app.mount(
            "/whats-new",
            StaticFiles(directory=str(_whats_new_dir), html=True),
            name="whats_new_static",
        )
